...
PANDA_ROHAND_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "rohand": ImplicitActuatorCfg(
            ...
            effort_limit={
                "th_root_link": 100.0,
                "th_proximal_link": 100.0,
                "if_proximal_link": 100.0,
                "mf_proximal_link": 100.0,
                "rf_proximal_link": 100.0,
            },
            stiffness={
                "th_root_link": 600.0,
            ...
            damping={
                ...
                "th_proximal_link": 0.001,
                "if_proximal_link": 0.001,
                "mf_proximal_link": 0.001,
                "rf_proximal_link": 0.001,
                "lf_proximal_link": 0.001,
            },
            velocity_limit={
                "th_root_link": 100.0,
                "th_proximal_link": 100.0,
