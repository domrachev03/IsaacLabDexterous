...
from .tessolo_hand_env_cfg import TessoloHandEnvCfg


@configclass
class TessoloHandVisionEnvCfg(TessoloHandEnvCfg):
    # scene
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(0.132, 0, 1.0), rot=(0.7071, 0.0, 0.7071, 0.0), convention="world"),
    ...
    # env
    # proprio (132) + goal_keypoints (24) + CNN embedding (27) = 183
    observation_space = 156 + 27
    # full state (179) + CNN embedding (27) = 206
    state_space = 179 + 27


@configclass
class TessoloHandVisionEnvPlayCfg(TessoloHandVisionEnvCfg):
    # scene
...
class TessoloHandVisionEnv(InHandManipulationEnv):
    cfg: TessoloHandVisionEnvCfg

    def __init__(self, cfg: TessoloHandVisionEnvCfg, render_mode: str | None = None, **kwargs):
